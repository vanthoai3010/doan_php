...
<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<?php
							// Sử dụng PHP để hiển thị nội dung của thanh điều hướng dựa trên trạng thái đăng nhập
							session_start();
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					...
					$dbname = 'karmashop'; // Thay đổi thành tên database của bạn
			...
			<div class="container">
				...
				<div class="row">
					...
					try {
						...
						// Chuẩn bị và thực thi truy vấn SQL
						$stmt = $conn->prepare("SELECT * FROM upcoming_products	");
						$stmt->execute();
							...
							<div class="col-lg-3 col-md-6">
								<div class="single-product">
									...
									<div class="product-details">
										<h6><?php echo $row['ten']; ?></h6>
										<div class="price">
											<h6><?php echo $row['gia']; ?>₫</h6>
										</div>
										<div class="prd-bottom">
											<a href="ct-sp-sap-ra-mat.php?product_id=<?php echo $row['id']; ?>" class="social-info">
	...
	<script>
		function searchProduct() {
			...
			if (searchInput.trim() !== '') {
				// Chuyển hướng đến trang kết quả tìm kiếm với từ khóa tìm kiếm
				window.location.href = 'search.php?keyword=' + encodeURIComponent(searchInput);
			}
		}
	</script>
</body>
