...
<body>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form id="checkout-form" class="row contact_form" action="#" method="post" novalidate="novalidate">
                            ...
                            <div class="col-md-12 form-group p_star">
                                <select class="country_select">
                                    <option value="1">123 Trịnh Đình Thảo</option>
                                </select>
                            </div>
                            <div class="col-md-12 form-group">
                    ...
                    <div class="col-lg-4">
                        <div class="order_box">
                            ...
                            <a id="checkout-btn" type="submit" class="primary-btn" href="#">Thanh toán</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.getElementById("checkout-btn").addEventListener("click", function(event) {
            event.preventDefault(); // Prevent the default action of the link (page navigation)

            Swal.fire({
                title: "Thành công",
                text: "Đơn hàng của bạn đã được xác nhận và đang được xử lý. Cảm ơn bạn đã mua hàng tại cửa hàng chúng tôi!",
                icon: "success"
            });
        });
    </script>
