		...
		<div class="container">
			<div class="row s_product_inner">
				...
				try {
					...
					// Kiểm tra xem có ID sản phẩm được chọn không
					if (isset($_GET['product_id'])) {
						$product_id = $_GET['product_id'];

						// Chuẩn bị và thực thi truy vấn SQL để lấy thông tin chi tiết sản phẩm
						$stmt = $conn->prepare("SELECT * FROM sneaker_products WHERE id = :id");
				...
				?>
							<div class="container">
								<div class="row">
									<div class="col-lg-6">
										<img class="img-fluid" src="<?php echo $product['hinh_anh']; ?>" alt="">
									</div>
									<div class="col-lg-6">
										<h2><?php echo $product['ten']; ?></h2>
										<h4 style="color:red;">Giá: <?php echo number_format($product['gia'], 0, ',', '.'); ?>₫</h4>
										<span>Thông tin chi tiết: </span>
										<p><?php echo $product['thong_tin_chi_tiet']; ?></p>
									</div>
								</div>
							</div>
				<?php
