...
<body>
    ...
    $host = 'localhost';
    $dbname = 'karmashop'; // Thay thế 'ten_database' bằng tên thật của cơ sở dữ liệu của bạn
    $user = 'root'; // Thay thế 'ten_nguoi_dung' bằng tên người dùng thật của bạn
    $password = ''; // Thay thế 'mat_khau' bằng mật khẩu thật của bạn
    ...
    try {
        ...
        // Tạo truy vấn SQL để tìm kiếm sản phẩm theo tên
        $sql = "SELECT * FROM sneaker_products WHERE ten LIKE :keyword";
        $stmt = $conn->prepare($sql);
        // Thêm dấu % vào trước và sau từ khóa để tìm kiếm theo một phần của tên sản phẩm
        $keyword = '%' . $keyword . '%';
    ...
    ?>
    <h1 class="text-center">Kết quả tìm kiếm cho : <?php echo  $keyword; ?></h1>
    <?php
    echo "<div class='row'>";
...
?>
        <div class="col-lg-3 col-md-6">
            <div class="single-product">
                <img style="width: 300px;" class="img-fluid" src="<?php echo $row['hinh_anh']; ?>" alt="">
                <div class="product-details">
                    ...
                    <div class="prd-bottom">
                        <form action="cart.php" method="post">
                            <button style="width:155px" type="submit" class="btn btn-dark" name="add_cart">Thêm vào giỏ hàng</button>
                            ...
                            <a href="single-product.php?product_id=<?php echo $row['id']; ?>" class="btn btn-primary" style="min-width: 80px;">Chi tiết</a>
                        </form>
                    </div>
                </div>
            </div>
